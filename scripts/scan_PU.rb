...
db.prepare('insert_pu','insert into pu (id, created_by, created_on, position, staff, type_pu, subtype, place_id) values ($1,$2,$3,ST_SetSRID(ST_Point($4,$5),4326),$6,$7,$8,$9)')
